...
angular.module('app.client').controller('OrgClientEditorController', function ($scope, $filter, $rootScope, $state, $stateParams, ClientService) {
    ...
    vm.unbindWechat = function (i) {
        ...
        vm.bindedWechats = vm.bindedWechats.splice(i, 1);
    }
